...
import sampleinternal.Filter;
//need to add logging module
import java.util.logging.*;

public class JokeProvider {
	private final static Logger LOGGER = Logger.getLogger(JokeProvider.class.getName());
	...
	List<String> jokes = List.of(
	    ...
	    public String getJoke() {
	        ...
	        LOGGER.info("JokeProvider fetching index is "+index);
